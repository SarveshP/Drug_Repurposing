...
```{r,include=FALSE}
blacklist = readr::read_csv('blacklist.csv')$feature
feature_df = readr::read_csv('transformed-features.csv') %>% dplyr::select(-dplyr::one_of(blacklist)) 
org_feature_df = readr::read_csv('features.csv')
transformed_df = readr::read_csv('transformed-features.csv')
```
...
write.csv(testData,file = "testdata1.csv")
```


```{r}
testData = readr::read_csv('testdata1.csv')
```
